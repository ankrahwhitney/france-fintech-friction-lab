...
1. **It targets the largest modelled loss.** Of 50,000 generated applications, the biggest
   absolute transition loss is before document submission: 13,847 applications, versus 11,602
...
2. **It scores best on the stated decision lens.** Against conversion impact (40%), guardrails
   (25%), speed to learn (20%) and evidence confidence (15%), the checklist scores 77.7/100,
   ahead of the contextual explainer (67.3) and assisted recovery (47.2)
...
- Modelled mean uplift: **91 incremental funded accounts per 10,000 applications** (10th–90th
  percentile 66–116), from a triangular 2–6 pp lift assumption on the document-submission stage.
- Modelled annual net value: **+€7,163 mean, with a 10th percentile of −€6,338** against €45,000
...
- Assisted recovery has the **highest** modelled conversion impact (128 per 10k) but fails the
  decision lens on guardrails, cost and delivery time, with a modelled net value of −€32,659.
...
days is the directional secondary metric; verification pass rate, manual review, support contact
and compliance indicators are guardrails. Full design in `docs/90_day_plan.md`.
