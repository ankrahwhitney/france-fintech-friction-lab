...
replace each one before or during the build phase (days 1–30 of the 90-day plan), and the
regulatory anchors any onboarding change must respect.
...
| CNIL / GDPR data-minimisation | The contextual explainer variant explains *why* each field is collected; its copy is a privacy-communication artifact and needs CNIL-lens review, not just marketing review. |
| ACPR supervision (AML/CFT under the Code monétaire et financier) | The French supervisor for onboarding/KYC compliance; any sequence change to identification steps goes through the compliance owner before experimentation. |
...
| 4 | Ops shadowing of manual-review queue: latency distribution, rework causes | 1 week | generator's missing review-gates-verification link; `manual_review_delta_pp`; kill-switch thresholds |
